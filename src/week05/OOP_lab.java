...
public static void main(String[] args) {
	...
	Card card2 = new Card("Ace", "Diamonds", 14);
	Card card3 = new Card("Three", "Hearts", 3);
	...
	int numPlayers = 4;
	Map<String, List<Card>> gameBoard = createGame(numPlayers);
...
// Method 5:
		public static Map<String, List<Card>> createGame (int numPlayers){
			...
			//make each new player and their cards
			for (int i = 1; i <= numPlayers; i++) {
